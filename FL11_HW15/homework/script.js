class Hamburger{
    ...
    addCheese(){
        if(Hamburger.bite > 0) return console.log('Sorry, you cannot add cheese');
    ...
    addTomato(){            
        if(Hamburger.bite > 0) return console.log('Sorry, you cannot add tomato');
    ...
    addSecretIngredient(){
        if(Hamburger.bite > 0) return console.log('Sorry, you cannot add secret ingredient');
